...
class AccountReturnType(models.Model):
    ...
    def _generate_all_returns(self, country_code, main_company, tax_unit=None):
        ...
        if country_code == 'AT' and (ec_sales_return_type := self.env.ref('l10n_at_reports.at_ec_sales_list_return_type', raise_if_not_found=False)):
            ...
            ec_sales_list_tags_info = self.env['l10n_at.ec.sales.report.handler']._get_tax_tags_for_at_sales_report()
