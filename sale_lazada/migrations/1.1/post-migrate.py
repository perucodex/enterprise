...
def migrate(cr, version):
    ...
    # _configure_for_lazada function tag is skipped in that case.
    xmlids = (
        'sale_lazada.default_adjustment_product',
        'sale_lazada.default_discount_product',
    )
    ...
    if products:
        products._configure_for_lazada()
