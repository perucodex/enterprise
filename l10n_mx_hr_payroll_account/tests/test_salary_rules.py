...
class TestPayslipValidation(TestPayslipValidationCommon):
    ...
    def test_regular_payslip_minimum_wage_with_commissions(self):
        ...
        payslip_results = {'BASIC': 8364.0, 'HOLIDAY_TO_SUB': 0.0, 'GROSS_WITHOUT_HOLIDAY': 8364.0, 'HOLIDAYS_ON_TIME': 0.0, 'COMMISSIONS': 1000.0, 'GROSS': 9364.0, 'ISR': -701.71, 'SUBSIDY': 474.95, 'SUBSIDY_CURRENT_MONTH': 474.95, 'INT_DAY_WAGE_BASE': 290.26, 'INT_DAY_WAGE_COMMISSIONS': 0.0, 'INT_DAY_WAGE_OTHER': 0.0, 'INT_DAY_WAGE': 290.26, 'RISK_IMSS_EMPLOYER': 44.99, 'DIS_FIX_IMSS_EMPLOYER': 686.6, 'DIS_ADD_IMSS_EMPLOYER': 0.0, 'DIS_ADD_IMSS_EMPLOYEE': 0.0, 'DIS_MED_IMSS_EMPLOYER': 94.48, 'DIS_MED_IMSS_EMPLOYEE': -33.74, 'DIS_MON_IMSS_EMPLOYER': 62.99, 'DIS_MON_IMSS_EMPLOYEE': -22.49, 'DIS_LIF_IMSS_EMPLOYER': 157.46, 'DIS_LIF_IMSS_EMPLOYEE': -56.24, 'RETIRE_IMSS_EMPLOYER': 179.96, 'CEAV_IMSS_EMPLOYER': 477.52, 'CEAV_IMSS_EMPLOYEE': -101.23, 'NURSERY_IMSS_EMPLOYER': 89.98, 'INFONAVIT_IMSS_EMPLOYER': 449.9, 'IMSS_EMPLOYEE_TOTAL': 213.7, 'IMSS_EMPLOYER_TOTAL': 2243.88, 'NET':  8923.54, 'PROVISIONS_CHRISTMAS_BONUS': 355.18, 'PERIOD_PROVISIONS_CHRISTMAS_BONUS': 355.18, 'PROVISIONS_HOLIDAY_BONUS': 0.0, 'PERIOD_PROVISIONS_HOLIDAY_BONUS': 0.0, 'PROVISIONS_VACATIONS_BONUS': 3368.52, 'PERIOD_PROVISIONS_VACATIONS_BONUS': 3368.52}
        self._validate_payslip(payslip, payslip_results)
